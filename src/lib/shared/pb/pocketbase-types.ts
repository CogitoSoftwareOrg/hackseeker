...
export enum ArtifactsImportanceOptions {
	"low" = "low",
	"mid" = "mid",
	"high" = "high",
}
export type ArtifactsRecord<Tmetadata = unknown, Tpayload = unknown> = {
	created: IsoAutoDateString
	file?: FileNameString
	id: string
...
export type ArtifactsResponse<Tmetadata = unknown, Tpayload = unknown, Texpand = unknown> = Required<ArtifactsRecord<Tmetadata, Tpayload>> & BaseSystemFields<Texpand>
